...
<li><a href="{{ URL::to('/cat/'.$im) }}">{{ $name_cat }}</a> </li>
<li>{{ $name_sub }}</li>
 ...
 <h1 class="page-header">
  ...
  <!-- long_text  -->
    ...
    href  = "{{ URL::to
    ('see_more/'.$name_cat.'/'.$name_sub.'/'.$post->id)}} " 
    id    = "$id"
    >
...
<!-- --------------------------------------------------------------------------------->
   ...
   <ul class="list-unstyled">
      ...
      <li> <a href="{{ URL::to('/cat/'.$category -> name) }}">  {{ $category -> name}} </a> </li>
...
<?php 
	  ...
	  $ex_1   =  explode(' ',$name_cat);	
	  $im_1   = implode('-',$ex_1);
	  
	  $ex_2   =  explode(' ',$sub_category -> name_sub);	
	  $im_2   = implode('-',$ex_2);
  ...
  <li> <a href="{{ URL::to('/cat/'.$im_1.'/'.$im_2) }}"> {{ $sub_category -> name_sub}} </a> </li>
